...
func reset_game():
	...
	p1_stats = {
		"health_bonus": 1, "damage_bonus": 0, "speed_bonus": 0, "dashspeed_bonus": 0,
		"dashcooldown_bonus": 0, "defense_bonus": 1, "leech": 0, "thorns": 0,
		"gaurdbreaker": 1, "punchSpeed": 1, "knockback_bonus": 1, "bulldozer": 0,
		"uppercut": 1, "coupdegras": 1, "unstoppable": 0, "explosion": 1
	}
	
	# Note: Boss 1 usually has 0.85 defense in your original code
	boss1_stats = p1_stats.duplicate()
	boss1_stats["defense_bonus"] = 0.85 
	
	boss2_stats = p1_stats.duplicate()
	boss3_stats = p1_stats.duplicate()
